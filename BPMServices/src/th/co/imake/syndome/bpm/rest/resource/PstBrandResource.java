...
public class PstBrandResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstBrand.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstBrand xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstBrand();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstBrand) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstBrand bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstBrand();
						...
						if(serviceName.equals(ServiceConstant.PST_BRAND_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstBrand pstBrand = (th.co.imake.syndome.bpm.hibernate.bean.PstBrand)obj;
								BeanUtils.copyProperties(pstBrand, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstBrand> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBrand>(1);
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstBrand item = new th.co.imake.syndome.bpm.hibernate.bean.PstBrand();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstBrand> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstBrand>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstBrand> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBrand>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstBrand xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstBrand> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBrand>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstBrand> getxPstBrandObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstBrand> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstBrand> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBrand>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstBrand missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstBrand xmissManual =new th.co.imake.syndome.bpm.xstream.PstBrand ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		th.co.imake.syndome.bpm.xstream.PstBrand  xbpsTerm =new th.co.imake.syndome.bpm.xstream.PstBrand();
		th.co.imake.syndome.bpm.hibernate.bean.PstBrand pstBrand =new  th.co.imake.syndome.bpm.hibernate.bean.PstBrand();
		xbpsTerm.setPbId(1l);
		Object obj= pstCommonService.findById(pstBrand.getClass(), xbpsTerm.getPbId());
		if(obj!=null){
			 pstBrand = (th.co.imake.syndome.bpm.hibernate.bean.PstBrand)obj;
			BeanUtils.copyProperties(pstBrand, xbpsTerm) ;
		}
	//logger.debug(" object return ="+ntcCalendarReturn);
	VResultMessage vresultMessage = new VResultMessage();
