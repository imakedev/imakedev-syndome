...
import th.co.imake.syndome.bpm.managers.PstEmployeeService;
...
public class PstEmployeeResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstEmployee.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstEmployee xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstEmployee();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstEmployee) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstEmployee bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstEmployee();
						...
						{
							th.co.imake.syndome.bpm.hibernate.bean.PstPosition pstPosition = new th.co.imake.syndome.bpm.hibernate.bean.PstPosition(); 
						...
						if(serviceName.equals(ServiceConstant.PST_EMPLOYEE_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstEmployee pstEmployee = (th.co.imake.syndome.bpm.hibernate.bean.PstEmployee)obj;
						...
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstEmployee> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstEmployee>(1);
						...
						//	java.sql.Timestamp timeStampStartDate = new java.sql.Timestamp(new Date().getTime());
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstEmployee item = new th.co.imake.syndome.bpm.hibernate.bean.PstEmployee();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstEmployee> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstEmployee>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstEmployee> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstEmployee>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstEmployee xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstEmployee> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstEmployee>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstEmployee> getxPstEmployeeObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstEmployee> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstEmployee> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstEmployee>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstEmployee missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstEmployee xmissManual =new th.co.imake.syndome.bpm.xstream.PstEmployee ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		th.co.imake.syndome.bpm.xstream.PstEmployee  xbpsTerm =new th.co.imake.syndome.bpm.xstream.PstEmployee();
		th.co.imake.syndome.bpm.hibernate.bean.PstEmployee pstEmployee =new  th.co.imake.syndome.bpm.hibernate.bean.PstEmployee();
		xbpsTerm.setPeId(1l);
		Object obj= pstCommonService.findById(pstEmployee.getClass(), xbpsTerm.getPeId());
		if(obj!=null){
			 pstEmployee = (th.co.imake.syndome.bpm.hibernate.bean.PstEmployee)obj;
