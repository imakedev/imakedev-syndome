...
public class RoleContactResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.RoleContact.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.RoleContact xbpsTerm = new th.co.imake.syndome.bpm.xstream.RoleContact();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.RoleContact) ntcCalendarObj;
				if (xbpsTerm != null) {
				
					 
					th.co.imake.syndome.bpm.hibernate.bean.RoleContact bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.RoleContact();
					...
					if (xbpsTerm.getServiceName() != null
						...
						if(serviceName.equals(ServiceConstant.ROLE_CONTACT_FIND_BY_ID)){
							th.co.imake.syndome.bpm.hibernate.bean.RoleContact ntcCalendarReturn = roleContactService.findRoleContactById(bpsTerm.getRcId());
						logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(ntcCalendarReturn!=null){
								List<th.co.imake.syndome.bpm.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleContact>(1);
								th.co.imake.syndome.bpm.xstream.RoleContact xntcCalendarReturn = new th.co.imake.syndome.bpm.xstream.RoleContact();
						...
						/*else if(serviceName.equals(ServiceConstant.ROLE_CONTACT_ITEMS_DELETE)){
							...
							List<th.co.imake.syndome.bpm.xstream.RoleContact> xntcCalendars = roleContactService.listRoleContactBymaId(xbpsTerm.getMaId());
							...
							if (result != null && result.size() == 2) {
								@SuppressWarnings("unchecked")
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleContact> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleContact>) result
										.get(0);
								String faqs_size = (String) result.get(1);
//								 
								VResultMessage vresultMessage = new VResultMessage();

								List<th.co.imake.syndome.bpm.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleContact>();
...
//			 
	...
	private List<th.co.imake.syndome.bpm.xstream.RoleContact> getxRoleContactObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleContact> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleContact>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.RoleContact missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.RoleContact xmissManual =new th.co.imake.syndome.bpm.xstream.RoleContact ();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.RoleContact xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.RoleContact> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleContact>(1);
