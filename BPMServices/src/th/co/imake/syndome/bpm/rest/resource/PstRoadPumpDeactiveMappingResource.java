...
import th.co.imake.syndome.bpm.managers.PstRoadPumpDeactiveMappingService;
...
public class PstRoadPumpDeactiveMappingResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping();
						BeanUtils.copyProperties(xbpsTerm,bpsTerm); 
						if(serviceName.equals(ServiceConstant.PST_ROAD_PUMP_DEACTIVE_MAPPING_FIND_BY_ID)){
							th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMappingPK pk=
									new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMappingPK(
											xbpsTerm.getPrpId(),xbpsTerm.getPwtId(),xbpsTerm.getPdId());
							Object obj= pstCommonService.findById(bpsTerm.getClass(), pk);
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping pstRoadPumpDeactiveMapping = (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping)obj;
								BeanUtils.copyProperties(pstRoadPumpDeactiveMapping, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping>(1);
							...
							th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMappingPK  pk=null;
							pk=(th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMappingPK) (pstCommonService.save(bpsTerm));
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping> getxPstRoadPumpDeactiveMappingObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpDeactiveMapping missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping xmissManual =new th.co.imake.syndome.bpm.xstream.PstRoadPumpDeactiveMapping ();
