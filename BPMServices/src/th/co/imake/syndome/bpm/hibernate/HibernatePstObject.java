...
import th.co.imake.syndome.bpm.hibernate.bean.PstMaintenanceTranPK;
		...
		for (int i = 0; i < query.length; i++) {
			...
			queryHQL=session.createQuery(sb.toString());
			 if(mode.equals("update")){
				 if(((Long)queryHQL.uniqueResult()).intValue()==0){
					 //save
					 th.co.imake.syndome.bpm.hibernate.bean.PstCheckingMapping mapping= new th.co.imake.syndome.bpm.hibernate.bean.PstCheckingMapping();
					 th.co.imake.syndome.bpm.hibernate.bean.PstCheckingMappingPK pk=new th.co.imake.syndome.bpm.hibernate.bean.PstCheckingMappingPK();
					 pk.setPcmType(queryArray[0]);
					 pk.setPcmRefTypeNo(Long.valueOf(queryArray[1]));
					 pk.setPdId(Long.valueOf(queryArray[2]));
					 pk.setPwtId(Long.valueOf(queryArray[3]));
