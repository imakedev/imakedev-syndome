...
function exportReport10(){   
	...
	var src = "report/exportReport10/"+start_date+"/"+end_date;
           ...
           <input type="hidden" id="pageNo" value="1"/>
            ...
            <input type="hidden" id="pageCount" value="1"/>
			   ...
			   <div style="border: 1px solid #FFC299;background: #F9F9F9;padding: 10px"> 
	    					...
	    					<span><strong>รายงานการขายเครื่องใหม่เป็นฐานMA</strong></span>
						...
						<table width="100%">
							<tr>
								<td> 
									...
									<a class="btn" style="margin-top: -10px;"
									onclick="exportReport10()">&nbsp;Export&nbsp;</a>
