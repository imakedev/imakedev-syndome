...
var product_code=jQuery.trim($("#product_code").val()); 
		...
		<%--	
		 <option value="-1,-1_-1"> ALL </option> 
										 ...
										 <option value="numfon,4_3">ฝ่าย SC</option> 
										  --%> 
	var src = "report/exportReport9/"+start_date+"/"+end_date+"/"+product_code;
           ...
           <input type="hidden" id="pageNo" value="1"/>
            ...
            <input type="hidden" id="pageCount" value="1"/>
			   ...
			   <div style="border: 1px solid #FFC299;background: #F9F9F9;padding: 10px"> 
	    					...
	    					<span><strong>รายงาน ข้อมูล SO</strong></span>
								...
								<td> 
									...
									<span style="padding: 5px;">
									 ...
									 <span style="padding-left:20px"> 
	 									 รหัสสินค้า : 
	 									 <input type="text" id="product_code" style="height: 30; width: 100px"/>
	 								  </span> 
									...
									<a class="btn" style="margin-top: -10px;"
									onclick="exportReport9()">&nbsp;Export&nbsp;</a>
