...
function doSLAAction(){
	...
	var bsSlaDetail=jQuery.trim($("#bsSlaDetail").val());
	 ...
	 if(bsSlaLimit.length==0){
		 alert("กรุณากรอก SLA Limit/Hour.");
		 $("#bsSlaLimit").focus();
		 return false;
	 }
	 var isNumber=checkNumberDecimal(jQuery.trim($("#bsSlaLimit").val())); 
	 if(isNumber){  
		 alert('กรุณากรอก  SLA Limit/Hour เป็นตัวเลขจำนวนเต็ม.');  
		 $("#bsSlaLimit").focus(); 
		 return false;	  
	 }
	var querys=[];
			    ...
			    <table border="0" width="100%" style="font-size: 12px">
    				...
    				<tr valign="middle">
    					...
    					<td width="75%" colspan="2"> 
    						<input type="text" name="bsName" id="bsName" style="height: 30;"/>
    					</td> 
    				</tr>
    				<tr valign="middle">
    					<td width="25%" align="right"><span style="font-size: 13px;padding: 15px">SLA Limit/Hour :</span></td>
    					<td width="75%" colspan="2"> 
