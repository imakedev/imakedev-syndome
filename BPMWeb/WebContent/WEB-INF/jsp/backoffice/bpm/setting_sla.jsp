	...
	SynDomeBPMAjax.searchObject(queryObject,{
		callback:function(data){
			...
			var str="	  <table class=\"table table-striped table-bordered table-condensed\" border=\"1\" style=\"font-size: 12px\"> "+
			        ...
			        "  		<th width=\"22%\"><div class=\"th_class\">Name</div></th> "+
			        "  		<th width=\"15%\"><div class=\"th_class\">SLA Limit/Hour</div></th> "+  
			        "  		<th width=\"50%\"><div class=\"th_class\">Detail</div></th> "+
			   ...
			   if(data!=null && data.length>0){
				   for(var i=0;i<data.length;i++){
					   ...
					   "  		<td style=\"text-align: left;\"> "+data[i][1]+" </td>"+    
				        ...
				        "    	<i title=\"Edit\" onclick=\"loadDynamicPage('setting/page/sla_management?bsId="+data[i][0]+"&mode=edit')\" style=\"cursor: pointer;\" class=\"icon-edit\"></i>&nbsp;&nbsp;"+
