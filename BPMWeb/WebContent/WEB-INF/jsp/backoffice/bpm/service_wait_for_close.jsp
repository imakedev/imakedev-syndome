                ...
                <tbody>
                  <tr>
                    ...
                    <a class="btn btn-info" onClick="loadDynamicPage('dispatcher/page/todolist')"> <span style="color:white; font-weight:bold; ">Back</span></a>&nbsp; 
                      <a class="btn btn-primary"  onclick="doCloseJob('2','wait_for_supervisor_services_close','${username}','1','Job Closed')"><i class="icon-ok icon-white"></i>&nbsp;<span style="color: white;font-weight: bold;">Close Job</span></a>
