	...
	" BCC_REMARK    = '"+BCC_REMARK+"' , "; 
	 ...
	 query=query+" BCC_ZIPCODE    = '"+BCC_ZIPCODE+"'   ";
		...
		query=query+" WHERE BCC_NO = '${bccNo}' ";
		 ...
		 var SBJ_JOB_PROBLEM_ID = jQuery.trim($("#SBJ_JOB_PROBLEM_ID").val());	
		 var SBJ_JOB_PROBLEM_SOLUTION = jQuery.trim($("#SBJ_JOB_PROBLEM_SOLUTION").val());	
		...
		*/  
		 query2=query2+ " SBJ_JOB_PROBLEM_ID = '"+SBJ_JOB_PROBLEM_ID+"' , SBJ_JOB_PROBLEM_SOLUTION = '"+SBJ_JOB_PROBLEM_SOLUTION+"' ,  ";
...
*/
	 ...
	 */
	 ...
	 if(SBJ_CUSTOMER_RECIPIENT_TIME_OUT.length>0){
	  ...
	  query=query+ " SBJ_JOB_PROBLEM_ID = '"+SBJ_JOB_PROBLEM_ID+"' , SBJ_JOB_PROBLEM_SOLUTION = '"+SBJ_JOB_PROBLEM_SOLUTION+"' ,  ";
...
<span style="padding-left:10px">
  ...
  querys.push(query2); 
     // if(SBJ_JOB_STATUS!='3'){
		...
		else if(SBJ_DEPT_ID=='3'){ // IT REG ต่างจังหวัด
			 query="insert into "+SCHEMA_G+".BPM_TO_DO_LIST(BTDL_REF,BTDL_TYPE,BTDL_STATE,BTDL_OWNER,BTDL_OWNER_TYPE,BTDL_MESSAGE,"+
				"BTDL_SLA,BTDL_SLA_UNIT,BTDL_CREATED_TIME,BTDL_DUE_DATE,BTDL_HIDE,BTDL_REQUESTOR,REF_NO,BTDL_SLA_LIMIT_TIME) VALUES "+
		...
		//alert(query_update);
		 ...
		 // var SBJ_DEPT_ID=$("#SBJ_DEPT_ID").val();
			 ...
			 query2="update "+SCHEMA_G+".BPM_TO_DO_LIST set BTDL_HIDE='0',BTDL_ACTION_TIME=now()  where BTDL_REF='${bccNo}' and "+
			  ...
			  querys.push(query2); 
			  query2="update "+SCHEMA_G+".BPM_SERVICE_JOB set SBJ_CLOSE_DATE= now()  where BCC_NO='${bccNo}' ";
			  querys.push(query2); 
		 	querys.push(query2); 
		 SynDomeBPMAjax.executeQuery(querys,{
				callback:function(data){ 
              ...
              <table style="width: 100%" border="0">
                <tbody>
                  <tr>
                   ...
                   <c:if test="${isSupervisorAccount || isQuotationAccount || isKeyAccount}">
