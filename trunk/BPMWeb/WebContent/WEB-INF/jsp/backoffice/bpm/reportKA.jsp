...
function viewReport(){ 
	...
	SynDomeBPMAjax.getReportKA(start_date,end_date,viewSelect,viewJobSelect,{
...
function exportReportKA(){   
	...
	var viewSelect=$("#viewSelect").val();
	var viewJobSelect=$("#viewJobSelect").val();
	var src = "report/exportReportKA/"+start_date+"/"+end_date+"/"+viewSelect+"/"+viewJobSelect;
           ...
           <input type="hidden" id="pageNo" value="1"/>
            ...
            <input type="hidden" id="pageCount" value="1"/>
			   ...
			   <div style="border: 1px solid #FFC299;background: #F9F9F9;padding: 10px"> 
	    					...
	    					<span><strong>รายงาน แจ้งซ่อม KA</strong></span>
						...
						<table width="100%">
							<tr>
								<td> 
									...
									<span style="padding: 5px;">
									 ...
									 <span style="padding-left:20px"> 
	 									 ...
	 									 <select name="viewSelect" style="width:200px" id="viewSelect"> 
	 									 	...
	 									 	<option value="LHBANK">ธนาคารแลนด์แอนด์เฮ้าส์ จำกัด (มหาชน)</option>
	 									 	<option value="UOB">ธนาคารยูโอบี จำกัด (มหาชน)</option>
	 									 	<option value="GSB">ธนาคารออมสิน จำกัด (มหาชน)</option>
	 									 	<option value="BAAC">ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร</option>
	 									 	<option value="IBANK">ธนาคารอิสลามแห่งประเทศไทย</option>
	 									 	<option value="KKBANK">ธนาคารเกียรตินาคิน จำกัด (มหาชน)</option>
	 									 	<option value="TNC">ธนาคารธนชาต จำกัด (มหาชน)</option>
	 									 	<option value="GHBANK">ธนาคารอาคารสงเคราะห์</option>
	 									 	<option value="CIMB">ธนาคารซีไอเอ็มบีไทย จำกัด (มหาชน)</option>
	 									 	<option value="DLT">กรมขนส่ง</option>
	 									 	<option value="THAIPOST">บริษัทไปรษณีย์ไทย จำกัด</option>
	 									 	<option value="BIGC">บิ๊กซีและมินิบิ๊กซี</option>
	 									 </select>
	 								  </span> 
									...
									<a class="btn" style="margin-top: -10px;"
									onclick="exportReportKA()">&nbsp;Export&nbsp;</a>
