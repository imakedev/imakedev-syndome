...
function exportReport(){   
	...
	var src = "reportPending/exportReportCMBKKTech/"+typeSelect+"/"+deptSelect;
	if(deptSelect=='closing')
		src = "reportPending/exportReportCMQuotation/"+typeSelect+"/"+deptSelect;
           ...
           <input type="hidden" id="pageNo" value="1"/>
            ...
            <input type="hidden" id="pageCount" value="1"/>
			   ...
			   <div style="border: 1px solid #FFC299;background: #F9F9F9;padding: 10px"> 
	    					...
	    					<span><strong>รายงาน งานค้างCM</strong></span>
							...
							<tr>
								<td> 
									 <span style="padding-left:20px"> 
	 									 ประเภทงาน : 
	 									 <select name="typeSelect" style="width:200px" id="typeSelect"> 
	 								  ...
	 								  <span style="padding-left:20px"> 
	 									 ...
	 									 <select name="deptSelect" style="width:200px" id="deptSelect"> 
	 									 	<option value="techBKK">ช่าง กทม.</option>
	 									 	<option value="techReg">ช่าง ภูมิภาค</option>
	 									 	<option value="logisticBKK">จัดส่ง กทม.</option>
	 									 	<option value="logisticReg">จัดส่ง ภูมิภาค</option>
	 									 	<option value="closing">ปิดJob</option>
	 									 </select>
	 								  </span>
