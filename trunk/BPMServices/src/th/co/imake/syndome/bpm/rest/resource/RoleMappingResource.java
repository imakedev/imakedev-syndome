...
public class RoleMappingResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.RoleMapping.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.RoleMapping xbpsTerm = new th.co.imake.syndome.bpm.xstream.RoleMapping();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.RoleMapping) ntcCalendarObj;
				if (xbpsTerm != null) {
				
					 
					th.co.imake.syndome.bpm.hibernate.bean.RoleMapping bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.RoleMapping();
					...
					if (xbpsTerm.getServiceName() != null
						...
						/*else if(serviceName.equals(ServiceConstant.ROLE_MAPPING_ITEMS_DELETE)){
							...
							List<th.co.imake.syndome.bpm.xstream.RoleMapping> xntcCalendars = roleMappingService.listRoleMappingByrcId(xbpsTerm.getRcId());
							...
							if (result != null && result.size() == 2) {
								@SuppressWarnings("unchecked")
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleMapping> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleMapping>) result
										.get(0);
								String faqs_size = (String) result.get(1);
//								 
								VResultMessage vresultMessage = new VResultMessage();

								List<th.co.imake.syndome.bpm.xstream.RoleMapping> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleMapping>();
...
//			 
	...
	private List<th.co.imake.syndome.bpm.xstream.RoleMapping> getxRoleMappingObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.RoleMapping> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.RoleMapping> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleMapping>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.RoleMapping missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.RoleMapping xmissManual =new th.co.imake.syndome.bpm.xstream.RoleMapping ();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.RoleMapping xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.RoleMapping> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.RoleMapping>(1);
