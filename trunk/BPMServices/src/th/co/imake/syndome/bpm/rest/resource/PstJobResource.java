...
import th.co.imake.syndome.bpm.managers.PstJobService;
...
public class PstJobResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstJob.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstJob xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstJob();
			...
			if (ntcCalendarObj != null) {
				...
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstJob) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstJob bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstJob();
						...
						if(xbpsTerm.getPstConcrete()!=null && xbpsTerm.getPstConcrete().getPconcreteId()!=null &&  xbpsTerm.getPstConcrete().getPconcreteId().intValue()!=-1){
							th.co.imake.syndome.bpm.hibernate.bean.PstConcrete pstConcrete = new th.co.imake.syndome.bpm.hibernate.bean.PstConcrete();
						...
						if(xbpsTerm.getPstRoadPump()!=null && xbpsTerm.getPstRoadPump().getPrpId()!=null &&  xbpsTerm.getPstRoadPump().getPrpId().intValue()!=-1){
							th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump pstRoadPump = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump();
						...
						if(serviceName.equals(ServiceConstant.PST_JOB_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstJob pstJob = (th.co.imake.syndome.bpm.hibernate.bean.PstJob)obj;
								BeanUtils.copyProperties(pstJob, xbpsTerm,ignore) ;
								if(pstJob.getPstConcrete()!=null && pstJob.getPstConcrete().getPconcreteId()!=null ){
									th.co.imake.syndome.bpm.xstream.PstConcrete pstConcrete = new th.co.imake.syndome.bpm.xstream.PstConcrete();
								...
								if(pstJob.getPstRoadPump()!=null && pstJob.getPstRoadPump().getPrpId()!=null &&  pstJob.getPstRoadPump().getPrpId().intValue()!=-1){
									th.co.imake.syndome.bpm.xstream.PstRoadPump pstRoadPump = new th.co.imake.syndome.bpm.xstream.PstRoadPump();
						...
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstJob> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>(1);
						...
						//	java.sql.Timestamp timeStampStartDate = new java.sql.Timestamp(new Date().getTime());
							...
							th.co.imake.syndome.bpm.hibernate.bean.PstJobWork pstJobWork=new th.co.imake.syndome.bpm.hibernate.bean.PstJobWork();
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstJob item = new th.co.imake.syndome.bpm.hibernate.bean.PstJob();
							...
							if (result != null && result.size() == 2) { 
								/*java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstJob> ntcCalendars = (java.util.ArrayList<th.co.aoe.imake.pst.hibernate.bean.PstJob>) result
										.get(0);*/
								List<th.co.imake.syndome.bpm.xstream.PstJob> xntcCalendars  = (java.util.ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>) result
										.get(0);
							...
							List<th.co.imake.syndome.bpm.xstream.PstJob> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>();
							xntcCalendars.add(xbpsTerm);
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstJob xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstJob> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstJob> getxPstJobObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJob> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstJob> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstJob missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstJob xmissManual =new th.co.imake.syndome.bpm.xstream.PstJob ();
	...
	private List<th.co.imake.syndome.bpm.xstream.PstBreakDown> getxPstBreakDownObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstBreakDown> pstBreakDowns){
		List<th.co.imake.syndome.bpm.xstream.PstBreakDown> xpstBreakDowns = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBreakDown>(
				pstBreakDowns.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstBreakDown pstBreakDown : pstBreakDowns) {
	...
	private List<th.co.imake.syndome.bpm.xstream.PstEmployee> getxPstEmployeeObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstEmployee> pstEmployees){
		List<th.co.imake.syndome.bpm.xstream.PstEmployee> xpstEmployees = new ArrayList<th.co.imake.syndome.bpm.xstream.PstEmployee>(
				pstEmployees.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstEmployee pstEmployee : pstEmployees) {
			th.co.imake.syndome.bpm.xstream.PstEmployee xpstEmployee =new th.co.imake.syndome.bpm.xstream.PstEmployee (); 
			...
			{
				th.co.imake.syndome.bpm.xstream.PstPosition pstPosition = new th.co.imake.syndome.bpm.xstream.PstPosition(); 
			...
			{
				th.co.imake.syndome.bpm.xstream.PstTitle pstTitle = new th.co.imake.syndome.bpm.xstream.PstTitle(); 
	...
	private List<th.co.imake.syndome.bpm.xstream.PstCost> getxPstCostObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstCost> pstCosts){
		List<th.co.imake.syndome.bpm.xstream.PstCost> xpstCosts = new ArrayList<th.co.imake.syndome.bpm.xstream.PstCost>(
				pstCosts.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstCost pstCost : pstCosts) {
