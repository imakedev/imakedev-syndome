...
public class PstJobPayExtResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstJobPayExt.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstJobPayExt xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstJobPayExt();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstJobPayExt) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt();
						BeanUtils.copyProperties(xbpsTerm,bpsTerm,ignore_id); 
						
						th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExtPK pk =new th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExtPK();
						...
						if(serviceName.equals(ServiceConstant.PST_JOB_PAY_EXT_SAVE)){
							...
							th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExtPK  returnId=null;
							 
							Long pjNo=pstJobPayExtService.getNextPjpeNo(bpsTerm.getId().getPjId());
							bpsTerm.getId().setPjpeNo(pjNo);
							returnId=(th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExtPK) (pstCommonService.save(bpsTerm));
							...
							List result = (List) pstJobPayExtService.listPstJobPayExts(xbpsTerm.getPjId(), xbpsTerm.getPjpeNo());
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt>) result;
										 
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstJobPayExt> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobPayExt>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstJobPayExt xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstJobPayExt> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobPayExt>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstJobPayExt> getxPstJobPayExtObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstJobPayExt> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobPayExt>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstJobPayExt missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstJobPayExt xmissManual =new th.co.imake.syndome.bpm.xstream.PstJobPayExt ();
