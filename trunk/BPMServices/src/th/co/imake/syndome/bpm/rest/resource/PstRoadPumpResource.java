...
import th.co.imake.syndome.bpm.managers.PstRoadPumpService;
...
public class PstRoadPumpResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstRoadPump.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstRoadPump xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstRoadPump();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstRoadPump) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump();
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpStatus pstRoadPumpStatus = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpStatus(); 
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType pstRoadPumpType = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType(); 
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstBrand pstBrandRoad = new th.co.imake.syndome.bpm.hibernate.bean.PstBrand(); 
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstBrand pstBrandPump = new th.co.imake.syndome.bpm.hibernate.bean.PstBrand(); 
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstModel pstModelRoad = new th.co.imake.syndome.bpm.hibernate.bean.PstModel(); 
					...
					{
						th.co.imake.syndome.bpm.hibernate.bean.PstModel pstModelPump = new th.co.imake.syndome.bpm.hibernate.bean.PstModel(); 
						...
						if(serviceName.equals(ServiceConstant.PST_ROAD_PUMP_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump pstRoadPump = (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump)obj;
								...
								{
									th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus pstRoadPumpStatus = new th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus(); 
								...
								{
									th.co.imake.syndome.bpm.xstream.PstRoadPumpType pstRoadPumpType = new th.co.imake.syndome.bpm.xstream.PstRoadPumpType(); 
								...
								{
									th.co.imake.syndome.bpm.xstream.PstBrand pstBrandRoad = new th.co.imake.syndome.bpm.xstream.PstBrand(); 
								...
								{
									th.co.imake.syndome.bpm.xstream.PstBrand pstBrandPump = new th.co.imake.syndome.bpm.xstream.PstBrand(); 
								...
								{
									th.co.imake.syndome.bpm.xstream.PstModel pstModelRoad = new th.co.imake.syndome.bpm.xstream.PstModel(); 
								...
								{
									th.co.imake.syndome.bpm.xstream.PstModel pstModelPump = new th.co.imake.syndome.bpm.xstream.PstModel(); 
						...
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstRoadPump> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPump>(1);
						...
						//	java.sql.Timestamp timeStampStartDate = new java.sql.Timestamp(new Date().getTime());
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump item = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump();
						...
						//		java.sql.Timestamp timeStampStartDate = new java.sql.Timestamp(new Date().getTime());
							...
							if (result != null && result.size() == 2) {
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstRoadPump> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPump>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstRoadPump xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstRoadPump> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPump>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstBrand> getxPstBrandObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstBrand> pstBrands){
		List<th.co.imake.syndome.bpm.xstream.PstBrand> xpstBrands = new ArrayList<th.co.imake.syndome.bpm.xstream.PstBrand>(
				pstBrands.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstBrand pstBrand : pstBrands) {
			th.co.imake.syndome.bpm.xstream.PstBrand xpstBrand =new th.co.imake.syndome.bpm.xstream.PstBrand ();
	...
	private List<th.co.imake.syndome.bpm.xstream.PstModel> getxPstModelObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstModel> pstModels){
		List<th.co.imake.syndome.bpm.xstream.PstModel> xpstModels = new ArrayList<th.co.imake.syndome.bpm.xstream.PstModel>(
				pstModels.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstModel pstModel : pstModels) {
			th.co.imake.syndome.bpm.xstream.PstModel xpstModel =new th.co.imake.syndome.bpm.xstream.PstModel ();
			BeanUtils.copyProperties(pstModel, xpstModel,ignore);
			xpstModels.add(xpstModel);
		}
		return xpstModels;
	}
	private List<th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus> getxPstRoadPumpStatusObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpStatus> pstRoadPumpStatuss){
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus> xpstRoadPumpStatuss = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus>(
				pstRoadPumpStatuss.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpStatus pstRoadPumpStatus : pstRoadPumpStatuss) {
			th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus xpstRoadPumpStatus =new th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus ();
	...
	private List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> getxPstRoadPumpTypeObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType> pstRoadPumpTypes){
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> xpstRoadPumpTypes = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpType>(
				pstRoadPumpTypes.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType pstRoadPumpType : pstRoadPumpTypes) {
			th.co.imake.syndome.bpm.xstream.PstRoadPumpType xpstRoadPumpType =new th.co.imake.syndome.bpm.xstream.PstRoadPumpType ();
	...
	private List<th.co.imake.syndome.bpm.xstream.PstRoadPump> getxPstRoadPumpObject(
			java.util.List<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstRoadPump> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPump>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPump pstRoadPump : ntcCalendars) {
