...
import th.co.imake.syndome.bpm.managers.PstPositionService;
...
public class PstPositionResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstPosition.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstPosition xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstPosition();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstPosition) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstPosition bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstPosition();
						...
						if(serviceName.equals(ServiceConstant.PST_POSITION_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstPosition pstPosition = (th.co.imake.syndome.bpm.hibernate.bean.PstPosition)obj;
								BeanUtils.copyProperties(pstPosition, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstPosition> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstPosition>(1);
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstPosition item = new th.co.imake.syndome.bpm.hibernate.bean.PstPosition();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstPosition> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstPosition>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstPosition> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstPosition>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstPosition xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstPosition> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstPosition>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstPosition> getxPstPositionObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstPosition> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstPosition> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstPosition>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstPosition missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstPosition xmissManual =new th.co.imake.syndome.bpm.xstream.PstPosition ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		if(obj!=null){
			 pstPosition = (th.co.imake.syndome.bpm.hibernate.bean.PstPosition)obj;
			BeanUtils.copyProperties(pstPosition, xbpsTerm) ;
		}
	//logger.debug(" object return ="+ntcCalendarReturn);
	VResultMessage vresultMessage = new VResultMessage();
