...
import th.co.imake.syndome.bpm.xstream.PstBrand;
import th.co.imake.syndome.bpm.xstream.PstModel;
import th.co.imake.syndome.bpm.xstream.PstRoadPumpStatus;
import th.co.imake.syndome.bpm.xstream.PstRoadPumpType;
...
public class PstJobEmployeeResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstJobEmployee.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstJobEmployee xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstJobEmployee();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstJobEmployee) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee();
						BeanUtils.copyProperties(xbpsTerm,bpsTerm,ignore_id); 
						
						th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployeePK pk =new th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployeePK();
						...
						if(serviceName.equals(ServiceConstant.PST_JOB_EMPLOYEE_SAVE)){
							...
							th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployeePK  returnId=null;
							returnId=(th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployeePK) (pstCommonService.save(bpsTerm));
						...
						//	Pagging page = xbpsTerm.getPagging(); 
							...
							List result = (List) pstJobEmployeeService.listPstJobEmployees(xbpsTerm.getPjId(), xbpsTerm.getPeId(),xbpsTerm.getPrpId());
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee>) result;
										 
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstJobEmployee> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobEmployee>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstJobEmployee xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstJobEmployee> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobEmployee>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstJobEmployee> getxPstJobEmployeeObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstJobEmployee> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJobEmployee>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstJobEmployee missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstJobEmployee xmissManual =new th.co.imake.syndome.bpm.xstream.PstJobEmployee ();
