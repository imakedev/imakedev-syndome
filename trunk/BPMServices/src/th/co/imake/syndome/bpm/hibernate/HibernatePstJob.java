...
where job_work.pj_id=job.pj_id and road_pump.prp_no='HP0')
			 ...
			 */
				...
				// set pagging.
				 ...
				 List<th.co.imake.syndome.bpm.xstream.PstJob> xpstjobs = new ArrayList<th.co.imake.syndome.bpm.xstream.PstJob>(l.size());
					 
				 for (Object[] objects : l) {
					 th.co.imake.syndome.bpm.xstream.PstJob pstJob=new th.co.imake.syndome.bpm.xstream.PstJob();
