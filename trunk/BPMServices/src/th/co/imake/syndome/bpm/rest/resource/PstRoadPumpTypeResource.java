...
import th.co.imake.syndome.bpm.managers.PstRoadPumpTypeService;
...
public class PstRoadPumpTypeResource  extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.imake.syndome.bpm.xstream.PstRoadPumpType.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.imake.syndome.bpm.xstream.PstRoadPumpType xbpsTerm = new th.co.imake.syndome.bpm.xstream.PstRoadPumpType();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.imake.syndome.bpm.xstream.PstRoadPumpType) ntcCalendarObj;
				if (xbpsTerm != null) { 
					if (xbpsTerm.getServiceName() != null
						...
						th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType bpsTerm = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType();
						...
						if(serviceName.equals(ServiceConstant.PST_ROAD_PUMP_TYPE_FIND_BY_ID)){
							...
							if(obj!=null){
								th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType pstRoadPumpType = (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType)obj;
								BeanUtils.copyProperties(pstRoadPumpType, xbpsTerm) ;
							}
						//logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(xbpsTerm!=null){
								List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpType>(1);
						...
						//	java.sql.Timestamp timeStampStartDate = new java.sql.Timestamp(new Date().getTime());
							...
							for (int i = 0; i <ids.length; i++) {
								th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType item = new th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType();
							...
							if (result != null && result.size() == 2) {
								...
								java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType> ntcCalendars = (java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType>) result
										.get(0);
								String faqs_size = (String) result.get(1);
								VResultMessage vresultMessage = new VResultMessage();
								List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpType>();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.imake.syndome.bpm.xstream.PstRoadPumpType xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> xbpsTerms = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpType>(1);
	...
	private List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> getxPstRoadPumpTypeObject(
			java.util.ArrayList<th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType> ntcCalendars) {
		List<th.co.imake.syndome.bpm.xstream.PstRoadPumpType> xntcCalendars = new ArrayList<th.co.imake.syndome.bpm.xstream.PstRoadPumpType>(
				ntcCalendars.size());
		for (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType missManual : ntcCalendars) {
			th.co.imake.syndome.bpm.xstream.PstRoadPumpType xmissManual =new th.co.imake.syndome.bpm.xstream.PstRoadPumpType ();
	...
	protected Representation get(Variant variant) throws ResourceException {
		...
		if(obj!=null){
			 pstRoadPumpType = (th.co.imake.syndome.bpm.hibernate.bean.PstRoadPumpType)obj;
			BeanUtils.copyProperties(pstRoadPumpType, xbpsTerm) ;
		}
	//logger.debug(" object return ="+ntcCalendarReturn);
	VResultMessage vresultMessage = new VResultMessage();
